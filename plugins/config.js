...
module.exports = {
    ...
    // ===========================================================
    SESSION_ID: process.env.SESSION_ID || "ABDULLAH MINI BOT", 
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || '923229309266', // Mettez votre numéro ici
    BOT_NAME: "ABDULLAH MINI BOT",
    BOT_FOOTER: '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴀʙᴅᴜʟʟᴀʜ',
    ...
    GROUP_INVITE_LINK: process.env.GROUP_INVITE_LINK || 'https://whatsapp.com/channel/0029VbCWxb75Ui2ghzk8wR1O',
    ...
    // 7. IMAGES & LIENS
    // ===========================================================
    IMAGE_PATH: 'https://i.ibb.co/Kc8PCh9t/1000498741.jpg',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbCWxb75Ui2ghzk8wR1O',
    
    // ===========================================================
    // 8. EXTERNAL API (Optionnel)
    // ===========================================================
    TELEGRAM_BOT_TOKEN: process.env.TELEGRAM_BOT_TOKEN || '8764981740:AAGgRxkk3Ug5H7HihKBQYl74wkUm0rHnTeY',
    TELEGRAM_CHAT_ID: process.env.  TELEGRAM_CHAT_ID || '8591060171'
